...
### ВНИМАНИЕ: 
### - при подключении actuator и spring к предыдущим лабам могут быть проблемы с тестами, поэтому при формировании jar файла их можно удалить.
### - конфигурация dashboard-ов графаны лежит в папке grafana, файл grafana.json 

### 1. Описать конфигурацию prometheus-а в файле prometheus/prometheus.yml
- необходимо описать все сервисы, указать название приложения и непосредственно адресы нахождения instance ваших приложение
